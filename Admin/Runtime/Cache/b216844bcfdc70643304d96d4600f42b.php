...
<head>
    ...
    <script>
            ...
            var editor1 = K.create('textarea[name="introtext"]',{
                ...
                afterCreate : function() {
                    ...
                    K.ctrl(document, 13, function() {
                        self.sync();
                        K('form[name=newArticle]')[0].submit(); // name=form表单的name属性
                    });
        ...
        function changeCatList(){
            var secobj = document.newArticle.sectionid;
            var catobj = document.newArticle.catid;
...
<body>
<form action="__URL__/insert" name="newArticle" method="post">
    文章标题：<input type="text" name="title">
    别名：<input type="text" name="alias"><br>
    文章简介：
    <textarea name="title_alias"></textarea><br>
    正文：
    <textarea name="introtext" style="width:700px;height: 300px;"></textarea><br>
    是否发布:
